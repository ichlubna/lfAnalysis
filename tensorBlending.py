...
from generalTools import evaluator as eva
...
class KernelTester:
    ...
    warpSize = 32
    totalSize = 0
    kernelsPath = "/cudaKernels/tensorBlending/"
    lfReader = None
    imagesGPU = None
    textures = None
    resultGPU = None
    ...
    def compileKernels(self):
        ...
        kernelSourcePath = scriptPath+self.kernelsPath

        kernelConstants = [ "-I="+kernelSourcePath,
        ...
        kernelSourceMain =  open(kernelSourcePath+"mainInterpolation.cu", "r").read()
        kernelSourceGeneral = open(kernelSourcePath+"generalInterpolation.cu", "r").read()
        kernelSourcePerPixel = open(kernelSourcePath+"perPixelInterpolation.cu", "r").read()
        kernelSourceTensorInter = open(kernelSourcePath+"tensorInterpolation.cu", "r").read()
